    ...
    <div id="myCarousel" class="carousel slide" data-ride="carousel">
      ...
      <div class="carousel-inner">
        ...
        <div class="item active">
          <img src="img/banner/<?php echo $banner_detail->id; ?>/<?php echo $banner_detail->img_cover; ?>"
            alt="<?php echo $banner_detail->banner_name; ?>" style="width:100%;">
        </div>
        <?php else : ?>
        <div class="item">
          <img src="img/banner/<?php echo $banner_detail->id; ?>/<?php echo $banner_detail->img_cover; ?>"
              ...
              <div class="img-box-a">
                <div class="images-box-img">
                  <img src="img/blog/<?php echo $blog_detail->id; ?>/<?php echo $blog_detail->img_cover; ?>"
                    alt="<?php echo $blog_detail->blog_name; ?>" class="img-a img-fluid">
                </div>
              </div>
