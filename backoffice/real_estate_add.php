	...
	{	
		if(real_estate_add())
		{
			echo '<script>
					...
					window.location.href = "real_estate.php"
			      </script>';
			exit;
		}
	}
			            ...
			            <div class="panel-body container-fluid">
			              	<form id="serviceAdd" name="serviceAdd" class="form-horizontal" method="post" enctype="multipart/form-data">
				                <div class="form-group form-material" data-plugin="formMaterial">
				                  	...
				                  	<input type="text" class="form-control" id="urlname" name="urlname" placeholder="lawyer-house" required>
				                </div>
				                <div class="form-group form-material" data-plugin="formMaterial">
				                ...
				                <div class="form-group form-material" data-plugin="formMaterial">
				                  	...
				                  	<input type="text" class="form-control" id="name" name="name" placeholder="Real Estate Name" required>
				                </div>
				                <div class="form-group form-material" data-plugin="formMaterial">
				                  	<label class="form-control-label" for="title">Real Estate Name(EN)</label>
				                  	<input type="text" class="form-control" id="name_en" name="name_en" placeholder="Real Estate Name" required>
				                </div>
								<div class="form-group form-material" data-plugin="formMaterial">
				                ...
				                <div class="text-right">
						            ...
						            <button type="button" class="btn btn-animate btn-animate-side btn-default btn-outline" onclick="window.location.href = 'real_estate.php';">
