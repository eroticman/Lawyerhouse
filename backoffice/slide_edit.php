...
<head>
	...
	<title>Banner | Lawyer House </title>
			            ...
			            <div class="panel-body container-fluid">
			              	<form id="aboutusAdd" name="aboutusAdd" class="form-horizontal" method="post" enctype="multipart/form-data">
				                <div class="form-group form-material" data-plugin="formMaterial">
				                  	<label class="form-control-label" for="title">Banner Name</label>
				                  	<input type="text" class="form-control" id="name" name="name" value="<?php echo $slide_detail->banner_name; ?>" required>
				                </div>
								<div class="form-group form-material form-material-file" data-plugin="formMaterial">
				                  	<label class="form-control-label" for="image">Image Cover</label>
			                      	<input type="file" id="covImg" name="covImg" data-plugin="dropify" data-default-file="<?php echo '../img/banner/' . $slide_detail->id . '/' . $slide_detail->img_cover; ?>" data-allowed-file-extensions="png jpg"/>
