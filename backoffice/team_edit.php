...
<body class="animsition dashboard">
	...
	$team_detail = team_detail($_GET['id']);
	?>
			            ...
			            <div class="panel-body container-fluid">
			              	<form id="serviceAdd" name="serviceAdd" class="form-horizontal" method="post" enctype="multipart/form-data">
				                <div class="form-group form-material" data-plugin="formMaterial">
				                  	<label class="form-control-label" for="title">Full Name(TH)</label>
				                  	<input type="text" class="form-control" id="name" name="name" value="<?php echo $team_detail->name; ?>" required>
				                </div>
                                <div class="form-group form-material" data-plugin="formMaterial">
				                  	<label class="form-control-label" for="title">Full Name(EN)</label>
				                  	<input type="text" class="form-control" id="name_en" name="name_en" value="<?php echo $team_detail->name_en; ?>" required>
				                </div>
								...
								<div class="form-group form-material" data-plugin="formMaterial">
									...
									<textarea class="form-control summernote" rows="4" placeholder="Detail" id="editor_en" name="description_en">
											<?php echo $team_detail->description_en; ?>
									</textarea>
								</div>
								...
								<div class="form-group form-material form-material-file" data-plugin="formMaterial">
			                      	...
			                      	<input type="file" id="covImg" name="covImg" data-plugin="dropify" data-default-file="<?php echo '../img/team/' . $team_detail->id . '/' . $team_detail->img_cover; ?>" data-allowed-file-extensions="png jpg"/>
									<i class="help-block"><i>Image size: 1200x800px</i></p>
				                </div>
				                <div class="text-right">
				                	<input type="hidden" name="team_id" value="<?php echo $team_detail->id; ?>">
						            ...
						            <button type="button" class="btn btn-animate btn-animate-side btn-default btn-outline" onclick="window.location.href = 'team.php';">
