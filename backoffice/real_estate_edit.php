...
<body class="animsition dashboard">
	...
	$real_estate_detail = real_estate_detail($_GET['id']);
	?>
			            ...
			            <div class="panel-body container-fluid">
			              	<form id="serviceAdd" name="serviceAdd" class="form-horizontal" method="post" enctype="multipart/form-data">
				                ...
				                <div class="text-right">
						            ...
						            <button type="button" class="btn btn-animate btn-animate-side btn-default btn-outline" onclick="window.location.href = 'real_estate_.php';">
