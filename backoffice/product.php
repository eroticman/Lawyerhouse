...
<head>
	...
	<title>Product | X Home Car </title>
			                  					...
			                  					<tbody>
													...
													?>
			                  						<tr> 
                                                        ...
                                                        <td style=><img src="../img/product/cover/<?php echo $product_detail->id; ?>/<?php echo $product_detail->img_cover; ?>" style="width:15%;"></td>
			                  							<td style=""><?php echo $product_detail->category_name; ?></td>
			                  							<td style="">
