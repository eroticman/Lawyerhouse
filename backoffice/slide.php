...
<head>
	...
	<title>Banner Slide | Lawyer House </title>
...
<body class="animsition dashboard">
		...
		<div class="page-content container-fluid">
	      	...
	      	<div class="panel">
		        <div class="panel-heading">
		          	<h3 class="panel-title">Banner Slide</h3>
		        </div>
			                  					...
			                  					<tbody>
													...
													?>
			                  						<tr> 
			                  							...
			                  							<td style=""><?php echo $slide_detail->banner_name; ?></td>
			                  							<td style=><img src="../img/banner/<?php echo $slide_detail->id; ?>/<?php echo $slide_detail->img_cover; ?>" style="width:200px;"></td>
			                  							<td style="">
														  <?php if(!empty($slide_detail->updated)) {
																  echo date("d/m/Y", strtotime( $slide_detail->updated ) ); 
															} else {
																echo '-';
															}
														  ?>
     ...
     function deleteSlide()
    {
   		$.ajax({
		  	type 	: 'POST',
		  	url 	: 'queryDB.php',
		  	data 	: {sid:$('#sid').val(), action:'delSlide'},
