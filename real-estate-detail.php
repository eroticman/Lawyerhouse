...
<head>
  ...
  <title><?php echo $realDetail->service_name; ?> | Lawyer House</title>
  <meta content="width=device-width, initial-scale=1.0" name="viewport">
  <meta name="keywords" content="ทนายความ, บริษัท ลอว์เยอร์ เฮ้าส์ จำกัด, <?php echo $realDetail->keyword; ?> ">
  ...
  <base href="https://lawyerhouse.co.th/realestate">
      ...
      <div class="row">
        <div class="col-lg-12">
          <h1>
            <?php 
              if( $_SESSION['lang'] === 'th') {
                  echo $realDetail->real_estate_name;
              } else {
                  echo $realDetail->real_estate_name_en;
              }
            ?>
          </h1>
        </div>
      ...
      <div class="row">
        <div class="col-lg-12">
          <div class="services-page">
            <?php 
              if( $_SESSION['lang'] === 'th') {
                  echo $realDetail->description;
              } else {
                  echo $realDetail->description_en;
              }
            ?>
          </div>
        </div>
